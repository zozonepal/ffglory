...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-[#12141a] p-6 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
        ...
        <button
          onClick={logout}
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-rose-950/40 hover:bg-rose-900/50 border border-rose-500/30 text-rose-300 text-xs font-bold transition-colors cursor-pointer"
        >
